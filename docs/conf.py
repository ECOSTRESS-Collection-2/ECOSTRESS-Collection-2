...
latex_documents = [
    (master_doc, 'STARS.tex', u'STARS Documentation',
...
man_pages = [
    (master_doc, 'STARS', u'STARS Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'STARS', u'STARS Documentation',
     author, 'STARS', 'One line description of project.',
     'Miscellaneous'),
]
